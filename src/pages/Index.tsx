...
export default function Index() {
  ...
  return <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      <SEO title="AAASHA TRADING LTD - Leading Steel Trading & Sustainable Recycling Solutions" description="Transform your business with AAASHA TRADING LTD - India's premier steel trading and recycling company. Sustainable solutions, competitive prices, and exceptional service since inception." keywords="steel trading, recycling, sustainability, steel coils, pipes, structural steel, currency exchange, live rates, India steel trading, sustainable recycling" />
      ...
      <FeaturedVideos autoplay={true} muted={true} onVideoStart={videoId => {
      ...
      duration: 0.8
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <motion.h2 className="text-3xl md:text-5xl font-black text-white mb-6" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            <motion.p className="text-lg md:text-xl text-green-300 mb-10 leading-relaxed" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
